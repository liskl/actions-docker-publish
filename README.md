...
Blantant Ripoff of: https://github.com/elgohr/Publish-Docker-Github-Action, moved to here for runtime code security, _only run code you control and have went over._

[![Actions Status](https://github.com/liskl/actions-docker-publish/workflows/Test/badge.svg)](https://github.com/liskl/actions-docker-publish/actions)
[![Actions Status](https://github.com/liskl/actions-docker-publish/workflows/Integration%20Test/badge.svg)](https://github.com/liskl/actions-docker-publish/actions)
[![Actions Status](https://github.com/liskl/actions-docker-publish/workflows/Integration%20Test%20Github/badge.svg)](https://github.com/liskl/actions-docker-publish/actions)
...
Hereby the main-branch is published as the latest-tag.
...
`snapshot-tag` is the tag that is generated by the [snapshot-option](https://github.com/liskl/actions-docker-publish#snapshot) and pushed  
